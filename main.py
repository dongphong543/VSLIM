...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int, default=36, help="random seed for initialization")
    ...
    parser.add_argument('--intent_loss_coef', type=float, default=1.0, help='Coefficient for intent loss')
    parser.add_argument('--slot_loss_coef', type=float, default=2.0, help='Coefficient for the slot loss.')
    parser.add_argument('--token_intent_loss_coef', type=float, default=2.0, help='Coefficient for token intent loss')
